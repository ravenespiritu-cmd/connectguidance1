#!/usr/bin/env node
/**
 * Delete an auth user (and dependent rows via FK cascade where defined).
 *
 * Usage:
 *   node scripts/delete-user.mjs --email admin@school.edu
 *
...
async function main() {
  ...
  if (args.help || !args.email) {
    console.log(`Usage: node scripts/delete-user.mjs --email <email>`);
  ...
  console.log("Deleted auth user:", args.email);
}
